...
import static com.example.task211.R.string.resultText;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void clickOnBtnOk (View BtnOk) {
        ...
        switch (count) {
            case 1:
                Toast.makeText(MainActivity.this, getString(R.string.resultText, inputMoney, bankCardType, inputInfo), Toast.LENGTH_LONG).show();
                break;
            case 2:
                Toast.makeText(MainActivity.this, getString(R.string.resultText, inputMoney, mobilePhoneType, inputInfo), Toast.LENGTH_LONG).show();
                break;
            case 3:
                Toast.makeText(MainActivity.this, getString(R.string.resultText, inputMoney, cashAddressType, inputInfo), Toast.LENGTH_LONG).show();
                break;
        }
    }
}
